...
<div class="container setup-page-container">
    <div class="rounded setup">
        <img src="/sysimages/ChronosLogo.png" id="chronos" alt="chronos TMS logo">

        <div class="setuptext">
            <h4 class="mb-5">First Time Setup</h4>
            <p><i>Please login with a company email address to
                    continue setup of Chronos Time Management System.</i></p>
        </div>
